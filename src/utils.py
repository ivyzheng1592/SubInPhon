...
def plot_txt_acc(acc_store: Mapping[str, Any], acc_plot: str) -> None:
    ...
    generalization_data = acc_data[acc_data["record_type"] == "gen"]
    ...
    if len(generalization_data) > 0:
        ax1.plot(generalization_data["epoch"], generalization_data["loss"], label="gen")
    ax1.legend()
    ax1.set_title("Loss")
    ax1.set_ylim(0, 3)
    ...
    if len(generalization_data) > 0:
        ax2.plot(generalization_data["epoch"], generalization_data["acc"], label="gen")
    ax2.legend()
    ax2.set_title("Acc")
    ax2.set_ylim(0, 1)
...
def plot_aud_acc(acc_store: Mapping[str, Any], acc_plot: str) -> None:
    ...
    if len(generalization_data) > 0:
        ax1.plot(generalization_data["epoch"], generalization_data["rec_loss"], label="gen")
    ax1.legend()
    ...
    if len(generalization_data) > 0:
        ax2.plot(generalization_data["epoch"], generalization_data["pred_loss"], label="gen")
    ax2.legend()
    ...
    if len(generalization_data) > 0:
        ax3.plot(generalization_data["epoch"], generalization_data["pred_acc"], label="gen")
    ax3.legend()
