...
- "results"
    - {trial_num} + "_" + {lang_name} + "_{property}_" + {modality}
        ...
        - {lang_name} + "_{property}_" + {modality} + "_embed_plots"
            - {lang_name} + "_{property}_" + {modality} + "_" + {directionality} + "_" + {condition} + "_run" + {run_num} + "_embedding.html"
            - {lang_name} + "_{property}_" + {modality} + "_" + {directionality} + "_" + {condition} + "_run" + {run_num} + "_epoch" + {epoch} + "_embedding.csv"
            - {lang_name} + "_{property}_" + {modality} + "_" + {directionality} + "_" + {condition} + "_run" + {run_num} + "_epoch" + {epoch} + "_embedding.png"
